...
(function($) {
    $.SeydoggySlideshow = function(settings) {
        ...
        if (sdSlideshow.find('img')) {
	        ...
	        // (this).src.substr($(this).length-4) === '.png' || $(this).src.substr(imgSrc.length-4) === '.PNG') {
	        // is).style.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled='true',sizingMethod='crop',src='" + $(this).src + "')";
	        // 
	        // 
			var i;
